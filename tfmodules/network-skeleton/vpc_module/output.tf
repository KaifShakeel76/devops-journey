...
#   description = "List of Protected Subnet IDs from the protected subnet module"
#   value       = module.protected_subnet[0].protected_subnet_ids
# }
output "protected_subnet_ids" {
  value = length(module.protected_subnet) > 0 ? module.protected_subnet[0].protected_subnet_ids : []
}
